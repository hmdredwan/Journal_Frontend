              ...
              <form onSubmit={handleChangePassword} className="mt-6 p-6 bg-gray-50 rounded-lg">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-end">
                  <button
                    ...
                    disabled={loading}
                    className="flex items-center gap-2 px-6 py-3 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-100 transition font-medium disabled:opacity-60 disabled:cursor-not-allowed"
                  >
                    <X size={20} />
                    Cancel
                  </button>
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="flex items-center gap-2 px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition font-medium shadow-sm disabled:bg-blue-400 disabled:cursor-not-allowed min-w-[160px] justify-center"
                  >
                    <Save size={20} />
